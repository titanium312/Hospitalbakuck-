 ...
 * — Componente Lit + Tachyons (fondo blanco, azules amables, animación elegante)
 * — Mantiene la integridad EXACTA del texto.
 * — Gráfico accesible hecho con SVG (donut).
 *
  ...
  #styles() {
    return html`<style>
      :root{
        ...
        --bp-azul-500:#1f7ae0; --bp-azul-400:#3e67ae; --bp-azul-300:#618dbe; --bp-azul-200:#b1deee;
        --bp-azul-100:#eef6ff; --bp-blanco:#ffffff;
      }

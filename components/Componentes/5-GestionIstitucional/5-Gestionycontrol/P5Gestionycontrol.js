...
import "../../herramienta/dictador.js"; // ✅ ruta corregida
...
class GestionControl extends LitElement {
  ...
  static styles = css`
    ...
    .title { margin: 0; font-size: 1rem; font-weight: 700; color: var(--blue-600); }
    .search {
      margin-top: 0.5rem; width: 100%;
      border: 1px solid var(--border); border-radius: 10px;
      padding: 0.5rem 0.75rem; font-size: 0.95rem; outline: none; background: #fff;
    }
    ...
    .item a {
      display: grid; grid-template-columns: 1fr auto; gap: 0.25rem 0.5rem; align-items: center;
      padding: 0.6rem 0.65rem; border-radius: 10px; text-decoration: none; color: var(--ink); outline: none;
    }
    ...
    .badge {
      ...
      border: 1px solid var(--border); border-radius: 999px; color: var(--slate-600); background: #fff; justify-self: end;
    }
    .item[aria-current="true"] a { background: #fff; border: 1px solid var(--blue-100); }

    .main {
      border: 1px solid var(--border); border-radius: var(--radius);
      background: #fff; box-shadow: var(--shadow); min-height: 240px; padding: 1rem;
    }
    .main-head {
    ...
    .main-title { margin: 0; font-size: 1.05rem; color: var(--blue-600); font-weight: 700; }
    .link {
      display: inline-flex; align-items: center; gap: 0.4rem; text-decoration: none; font-weight: 600;
      border: 1px solid var(--blue-100); border-radius: 10px; padding: 0.4rem 0.6rem; background: var(--blue-50); color: var(--blue-600);
    }

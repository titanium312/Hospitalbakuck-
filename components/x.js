...
class ContenedorApp extends LitElement {
  ...
  setActiveView(view) {
    ...
    const safe = String(view).toLowerCase().replace(/[^a-z0-9\-]/g, '');
  ...
  render() {
    ...
    const current = views[this.activeView] ?? html`
      <section aria-labelledby="titulo-construccion">
        <h1 id="titulo-construccion" class="f2 lh-title">Sección en construcción…</h1>
